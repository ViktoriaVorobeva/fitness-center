...
var _breakpoints = require("./modules/breakpoints");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  (0, _breakpoints.breakpointChecker)();
  (0, _video.playerInit)();
...
},{"./modules/breakpoints":2,"./modules/form-validate/form":4,"./modules/scroll":10,"./modules/slider":11,"./modules/tabs/init-tabs":12,"./modules/video":14,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.breakpointChecker = void 0;
var breakpoint = window.matchMedia('(max-width:1199px)');
var gymDescriptions = document.querySelectorAll('.gym p:not(:first-of-type)');
var breakpointChecker = function breakpointChecker() {
  if (gymDescriptions && breakpoint.matches) {
    gymDescriptions.forEach(function (description) {
      return description.classList.add('visually-hidden');
    });
  } else {
    gymDescriptions.forEach(function (description) {
      return description.classList.remove('visually-hidden');
    });
  }
};
exports.breakpointChecker = breakpointChecker;
breakpoint.addListener(breakpointChecker);
...
var navElements = document.querySelectorAll('.navigation__link');
var buttonPromotions = document.querySelector('.main-screen__button');
var getScroll = function getScroll() {
  ...
  if (buttonPromotions) {
    buttonPromotions.addEventListener('click', function (evt) {
      evt.preventDefault();
      var id = buttonPromotions.getAttribute('href');
      var target = document.querySelector(id);
      target.scrollIntoView({
        behavior: 'smooth'
      });
...
function addTabIndex() {
  var slideElements = document.querySelectorAll('.trainers__slide:not(.swiper-slide-duplicate)');
  var _iterator = _createForOfIteratorHelper(slideElements),
    _step;
  try {
...
var initSlider = function initSlider() {
  if (trainersSlider) {
    var sliderTrainers = new _swiper.default(trainersSlider, {
  ...
  if (reviewsSlider) {
    var sliderReviews = new _swiper.default(reviewsSlider, {
      direction: 'horizontal',
      loop: false,
      slidesPerView: 1,
      autoHeight: true,
...
var playerInit = function playerInit() {
  if (videoContainer) {
    var startButton = document.querySelector('.gym__button');
    var previewImage = document.querySelector('.gym__preview');
    startButton.addEventListener('click', function () {
      var iframeVideo = createIframe(videoContainer);
